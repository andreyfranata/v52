...
rows: [
{title: `💬 XL`, rowId: ".xl", description: "Menampilkan Config XL"},
{title: `🌱 AXIS`, rowId: ".axis", description: "Menampilkan Config AXIS"},
{title: `✨ TELKOMSEL`, rowId: ".telkomsel", description: "Menampilkan Config TELKOMSEL"},
{title: `✨ BYU`, rowId: ".byu", description: "Menampilkan Config BYU"},
{title: `🎮 INDOSAT`, rowId: ".indosat", description: "MMenampilkan Config INDOSAT"},
...
'fileName':'𝙱𝚘𝚝 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙 𝙱𝚢 𝙰𝙽𝙳𝚁𝙴𝚈 𝙵𝚁𝙰𝙽𝙰𝚃𝙰',
...
'title': '𝙱𝙾𝚃 𝙼𝚄𝙻𝚃𝙸 𝙳𝙴𝚅𝙸𝙲𝙴 𝙱𝚈 𝙰𝙽𝙳𝚁𝙴𝚈 𝙵𝚁𝙰𝙽𝙰𝚃𝙰',
'body':'',
'mediaType': 2,
